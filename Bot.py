...
# === USER CONFIGURATION ===
lichess_token = "TokenTimeIsBackBuddyss"  # Your API token as a string
engine_path = r"./engines/stockfish"      # Path to your engine
bot_username = "indibot"                  # Set your bot's Lichess username here (lowercase)
            ...
            for attempt in range(5):
                try:
                    ...
                    try:
                        ...
                        # Offer draw if losing after move 30, every 10 moves
